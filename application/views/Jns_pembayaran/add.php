				...
				<section class="section">
					...
					<div class="section-body">
						<div class="card">
							...
							<div class="card-body">
							<?php echo form_open('jns_pembayaran/add',array("class"=>"form-horizontal")); ?>

								<div class="form-group">
									<label for="jns_pembayaran" class="col-md-2 control-label">Jenis Pembayaran</label>
									<div class="col-md-4">
										<input type="text" name="jns_pembayaran" value="<?php echo $this->input->post('jns_pembayaran'); ?>" class="form-control" id="jns_pembayaran" />
									</div>
								</div>

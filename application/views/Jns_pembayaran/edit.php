				...
				<section class="section">
					...
					<div class="section-body">
						<div class="card">
							...
							<div class="card-body">
							<?php echo form_open('jns_pembayaran/edit/'.$jns_pembayaran['id'],array("class"=>"form-horizontal")); ?>

								<div class="form-group">
									<label for="jns_pembayaran" class="col-md-2 control-label">Jns Pembayaran</label>
									<div class="col-md-4">
										<input type="text" name="jns_pembayaran" value="<?php echo ($this->input->post('jns_pembayaran') ? $this->input->post('jns_pembayaran') : $jns_pembayaran['jns_pembayaran']); ?>" class="form-control" id="jns_pembayaran" />
									</div>
								</div>
	
								<div class="form-group">
									<div class="col-sm-offset-2 col-sm-4">
										<a href="<?php echo site_url('jns_pembayaran/index'); ?>" class="btn btn-danger">Back</a>

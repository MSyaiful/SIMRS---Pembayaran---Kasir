					...
					<div class="section-body">
						<div class="card">
							<div class="card-header">
								<h4>Tambah Data Card</h4>
							</div>
							<div class="card-body">
							<?php echo form_open('card/add',array("class"=>"form-horizontal")); ?>

								<div class="form-group">
									<label for="jns_card" class="col-md-2 control-label">Jenis Card</label>
									<div class="col-md-4">
										<input type="text" name="jns_card" value="<?php echo $this->input->post('jns_card'); ?>" class="form-control" id="jns_card" />
									</div>
								</div>

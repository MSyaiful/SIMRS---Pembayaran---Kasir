					...
					<div class="section-body">
						<div class="card">
							<div class="card-header">
								<h4>Edit Data Card</h4>
							</div>
							<div class="card-body">
							<?php echo form_open('card/edit/'.$card['id'],array("class"=>"form-horizontal")); ?>

								<div class="form-group">
									<label for="jns_card" class="col-md-2 control-label">Jenis Card</label>
									<div class="col-md-4">
										<input type="text" name="jns_card" value="<?php echo ($this->input->post('jns_card') ? $this->input->post('jns_card') : $card['jns_card']); ?>" class="form-control" id="jns_card" />
									</div>
								</div>
	
								<div class="form-group">
									<div class="col-sm-offset-2 col-sm-4">
										<a href="<?php echo site_url('card/index'); ?>" class="btn btn-danger">Back</a>

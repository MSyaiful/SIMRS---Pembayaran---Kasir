								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<input type="text" name="nama_pasien"
											value="<?php echo $this->input->post('nama_pasien'); ?>"
								...
								<div class="form-group">
									...
									<div class="col-md-3">
										<input type="date" name="tgl_masuk"
											value="<?php echo $this->input->post('tgl_masuk'); ?>" class="form-control"
											id="tgl_masuk" />
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-3">
										<input type="date" name="tgl_keluar"
											value="<?php echo $this->input->post('tgl_keluar'); ?>" class="form-control"
											id="tgl_keluar" />
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-4">
										<select name="jns_kamar" class="form-control" style="height:40px;">
											...
											<?php 
												...
												{
												$selected = ($kamar['id'] == $this->input->post('kamar')) ? ' selected="selected"' : "";
									...
									<div class="col-md-4">
										<select name="jns_penyakit" class="form-control" style="height:40px;">
											...
											<?php 
												...
												{
												$selected = ($penyakit['id'] == $this->input->post('penyakit')) ? ' selected="selected"' : "";
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<input type="text" name="alamat"
											value="<?php echo $this->input->post('alamat'); ?>" class="form-control"
											id="alamat" />
									</div>
								</div>
								<div class="form-group">
									<label for="no_tlp" class="col-md-2 control-label">No Tlp</label>
									<div class="col-md-3">
										<input type="text" name="no_tlp"
											value="<?php echo $this->input->post('no_tlp'); ?>" class="form-control"
											id="no_tlp" />
									</div>
								</div>

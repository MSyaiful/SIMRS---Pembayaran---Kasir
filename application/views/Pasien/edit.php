					...
					<div class="section-body">
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<input type="text" name="nama_pasien"
											value="<?php echo ($this->input->post('nama_pasien') ? $this->input->post('nama_pasien') : $pasien['nama_pasien']); ?>"
								...
								<div class="form-group">
									...
									<div class="col-md-3">
										<input type="date" name="tgl_masuk"
											value="<?php echo ($this->input->post('tgl_masuk') ? $this->input->post('tgl_masuk') : $pasien['tgl_masuk']); ?>"
											class="form-control" id="tgl_masuk" />
									</div>
								</div>
								<div class="form-group">
									<label for="tgl_keluar" class="col-md-2 control-label">Tanggal Keluar</label>
									<div class="col-md-3">
										<input type="date" name="tgl_keluar"
											value="<?php echo ($this->input->post('tgl_keluar') ? $this->input->post('tgl_keluar') : $pasien['tgl_keluar']); ?>"
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<select name="jns_kamar" class="form-control" style="height:40px;">
											...
											{
												$selected = ($kamar['id'] == $pasien['id']) ? ' selected="selected"' : "";
								...
								<div class="form-group">
									<label for="jns_penyakit" class="col-md-2 control-label">Penyakit</label>
									<div class="col-md-4">
										<select name="jns_penyakit" class="form-control" style="height:40px;">
											<option value="">Jenis Penyakit</option>
											<?php 
											foreach($all_penyakit as $penyakit)
											{
												$selected = ($penyakit['id'] == $pasien['id']) ? ' selected="selected"' : "";
								...
								<div class="form-group">
									<label for="no_tlp" class="col-md-2 control-label">No. Telepon</label>
									<div class="col-md-3">
										<input type="text" name="no_tlp"
											value="<?php echo ($this->input->post('no_tlp') ? $this->input->post('no_tlp') : $pasien['no_tlp']); ?>"

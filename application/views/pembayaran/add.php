...
<div class="form-group">
	...
	<div class="col-md-8">
		<input type="text" name="no_faktur" value="<?php echo $this->input->post('no_faktur'); ?>" class="form-control"
			id="no_faktur" />
...
<div class="form-group">
	...
	<div class="col-md-8">
		<input type="text" name="jns_kelamin" value="<?php echo $this->input->post('jns_kelamin'); ?>"
...
<div class="form-group">
	...
	<div class="col-md-8">
		<input type="text" name="tgl_masuk" value="<?php echo $this->input->post('tgl_masuk'); ?>" class="form-control"
			id="tgl_masuk" />
...
<div class="form-group">
	...
	<div class="col-md-8">
		<input type="text" name="tgl_keluar" value="<?php echo $this->input->post('tgl_keluar'); ?>"
...
<div class="form-group">
	...
	<div class="col-md-8">
		<input type="text" name="nama_pembayar" value="<?php echo $this->input->post('nama_pembayar'); ?>"
...
<div class="form-group">
	...
	<div class="col-md-8">
		<input type="text" name="jumlah_bayar" value="<?php echo $this->input->post('jumlah_bayar'); ?>"
...
<div class="form-group">
	...
	<div class="col-md-8">
		<input type="text" name="tgl_bayar" value="<?php echo $this->input->post('tgl_bayar'); ?>" class="form-control"
			id="tgl_bayar" />
...
<div class="form-group">
	...
	<div class="col-md-8">
		<input type="text" name="no_bukti" value="<?php echo $this->input->post('no_bukti'); ?>" class="form-control"
			id="no_bukti" />

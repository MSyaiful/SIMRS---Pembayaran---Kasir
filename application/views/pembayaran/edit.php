<?php echo form_open('pembayaran/edit/'.$pembayaran['id'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="jns_kelamin" class="form-control">
				...
				foreach($all_pasien as $pasien)
				{
					$selected = ($pasien['id'] == $pembayaran['jns_kelamin']) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="tgl_masuk" value="<?php echo ($this->input->post('tgl_masuk') ? $this->input->post('tgl_masuk') : $pembayaran['tgl_masuk']); ?>" class="form-control" id="tgl_masuk" />
		</div>
	</div>
	<div class="form-group">
		<label for="tgl_keluar" class="col-md-4 control-label">Tgl Keluar</label>
		<div class="col-md-8">
			<input type="text" name="tgl_keluar" value="<?php echo ($this->input->post('tgl_keluar') ? $this->input->post('tgl_keluar') : $pembayaran['tgl_keluar']); ?>" class="form-control" id="tgl_keluar" />
		</div>
	</div>
	<div class="form-group">
		<label for="total_harga" class="col-md-4 control-label">Total Harga</label>
		<div class="col-md-8">
			<input type="text" name="total_harga" value="<?php echo ($this->input->post('total_harga') ? $this->input->post('total_harga') : $pembayaran['total_harga']); ?>" class="form-control" id="total_harga" />
		</div>
	</div>
	<div class="form-group">
		<label for="kembalian" class="col-md-4 control-label">Kembalian</label>
		<div class="col-md-8">
			<input type="text" name="kembalian" value="<?php echo ($this->input->post('kembalian') ? $this->input->post('kembalian') : $pembayaran['kembalian']); ?>" class="form-control" id="kembalian" />
		</div>
	</div>
	<div class="form-group">
		<label for="kekurangan" class="col-md-4 control-label">Kekurangan</label>
		<div class="col-md-8">
			<input type="text" name="kekurangan" value="<?php echo ($this->input->post('kekurangan') ? $this->input->post('kekurangan') : $pembayaran['kekurangan']); ?>" class="form-control" id="kekurangan" />
		</div>
	</div>
